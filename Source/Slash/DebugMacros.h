...
#define DRAW_SPHERE_CUSTOM(Location, Size, Color) if(const UWorld* World = GetWorld()) DrawDebugSphere(World, Location, Size, 12, Color, true, 30.f);
...
#define DRAW_SPHERE_SINGLE_FRAME_CUSTOM(Location, Size, Color) if(const UWorld* World = GetWorld()) DrawDebugSphere(World, Location, Size, 12, Color, false, -1.f);
